    ...
    <form wire:submit.prevent="save">
        <div class="row justify-content-md-center">
            <div class="mb-3 col-md-9">
                <label for="formFile" class="form-label">Select PDF to Optimize (Max: 200MB)</label>
                <input class="form-control" type="file" id="formFile" wire:model="file" accept="application/pdf">
                @error('file')
                ...
                @if ($downloadUrl)
                    <div class="mt-4">
                        <div class="d-flex justify-content-center">
                            <h4>PDF optimized successfully!</h4>
                        </div>
                        <div class="d-flex justify-content-center">
